            ...
            {detailTab === "changes" && (
              <>
                ...
                <DiffChangesList
                  ...
                  totalChanges={
                    diff.totalChanges ?? diff.added + diff.removed + diff.modified
                  }
                  changesTruncated={diff.changesTruncated}
                  maxChangesApplied={diff.maxChangesApplied}
                  footerNote="Klicka på en rad för att zooma till objektet (punkter → 3000%)."
                />
              </>
            )}
          </section>
