            ...
            <>
              ...
              <HelpList
                items={[
                  ...
                  "Steg 5: se tillagda, borttagna och ändrade objekt i området — samma lagerfilter som i steget Kanter. Klicka på en rad i listan för att zooma dit i kartan, och kryssa ur «Ta med» för en ändring som inte ska tillämpas (borttag → objektet behålls, tillägg → objektet importeras inte, ändring → originalets version behålls). Bortkryssade rader ritas grå i kartan och följer med utcheckningen, så de hoppas över även vid incheckningen",
