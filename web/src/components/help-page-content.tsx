        ...
        <HelpSection id="faltredigering" title="Fältredigering">
          ...
          <HelpList
            items={[
              ...
              "Fyll yta (i CAD-verktyg): välj ytsymbol, aktivera verktyget och klicka i tomt omslutet område — ytan går ända ut till begränsningen; objekt inuti blir hål. Konturer, nordlinjer och banor ignoreras. Om området inte är omslutet visas ett meddelande",
