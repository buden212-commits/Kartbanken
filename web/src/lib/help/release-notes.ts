...
export const releaseNotes: ReleaseNote[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Om utcheckningsfilen i lagringen är en fullstor karta (teknisk begränsning) jämförs automatiskt mot basversionen inom urvalet i stället — så diffen inte hänger",
  ...
  },
  {
    ...
    items: [
      ...
      "Det går också åt andra hållet: klicka på en markering i kartan så väljs och rullas motsvarande rad fram i listan, redo att kryssas bort",
  ...
  },
  {
    ...
    items: [
      ...
      "Kantzon ca 30 m innanför polygonen: objekt där (t.ex. stenar nära snittet) tas inte bort automatiskt",
      "Jämförelsen sållar först geografiskt (AABB) — objekt långt bort på stora kartan hoppas över",
      "Blå markering i guiden visar polygonen, grön streckad linje den inre kärnan; status visar hur många objekt som faktiskt jämförs",
