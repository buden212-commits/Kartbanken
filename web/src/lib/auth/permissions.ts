...
export function roleDescription(role: RoleType): string {
  switch (role) {
    case Role.ADMIN:
      return "Allt redaktör kan, plus skapa områden, redigera områdesnamn och typ, radera områden, godkänna konton, avbryta utcheckningar, integrera incheckningar, tilldela fältredigering och hantera systeminställningar.";
    case Role.EDITOR:
